...
public class Limit_Sell extends AbstractOrder{
    ...
    public Limit_Sell(int orderId, double requestedPrice, double assetAmount, LocalDateTime date) {
        super(orderId, requestedPrice, assetAmount, date);
        logger.info("New Limit_Sell, without Asset and Wallet");
    }

    public Limit_Sell(Asset asset, double requestedPrice, double assetAmount, LocalDateTime date, Wallet sellerWallet) {
