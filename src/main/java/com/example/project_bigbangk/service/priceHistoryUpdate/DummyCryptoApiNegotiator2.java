...
public class DummyCryptoApiNegotiator2 implements ICryptoApiNegotiator {

    private final Logger logger = LoggerFactory.getLogger(DummyCryptoApiNegotiator2.class);


    public DummyCryptoApiNegotiator2() {
        super();
